...
<main class="p-8 w-full overflow-x-hidden">
	<div class="max-w-4xl mx-auto">
		...
		<a
			href="/blog"
			class="inline-flex items-center mb-8 pb-0.5 border-b border-transparent text-surface-500 hover:text-surface-400 dark:text-primary-500 dark:hover:text-primary-400 hover:underline underline-offset-4 hover:border-current transition-colors"
		>
