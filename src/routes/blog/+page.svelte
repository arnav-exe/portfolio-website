...
<svelte:head>
	...
	<meta name="description" content="Technical blog covering web development, cloud architecture, and software engineering by Arnav Jagetia." />
</svelte:head>
...
<div class="p-8 space-y-8">
	<div class="relative flex justify-center items-center">
		...
		<div class="absolute right-0">
			<RadioGroup background="bg-secondary-500 dark:bg-surface-900" active="bg-surface-900 dark:bg-primary-500" color="text-primary-500 dark:text-surface-900">
